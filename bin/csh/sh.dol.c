...
static	char	*Sccsid = "@(#)$Header: /d2/3.7/src/bin/csh/RCS/sh.dol.c,v 1.1 89/03/27 14:53:18 root Exp $";
/*
 * $Log:	sh.dol.c,v $
 * Revision 1.1  89/03/27  14:53:18  root
 * Initial check-in for 3.7
 * 
 * Revision 1.4  85/01/16  23:28:15  bob
 * Applied 4.2bsd changes to fix subtle bugs, e.g. $ENVVAR{this,that}.
 * 
 */
