...
static	char	*Sccsid = "@(#)$Header: /d2/3.7/src/bin/csh/RCS/sh.set.c,v 1.1 89/03/27 14:53:33 root Exp $";
/*
 * $Log:	sh.set.c,v $
 * Revision 1.1  89/03/27  14:53:33  root
 * Initial check-in for 3.7
 * 
 * Revision 1.3  85/06/18  18:40:14  bob
 * Fixed SCR 701 on env/var equiv for term user logname
 * 
 * Revision 1.2  85/01/16  21:21:54  bob
 * Fixed to provide diagnostic if specified $path is too long rather than
 * core dump.
 * 
 */
#include "sh.h"
