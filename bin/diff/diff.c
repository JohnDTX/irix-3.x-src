...
/*	@(#)diff.c	1.4	*/
static	char	*Sccsid = "@(#)$Header: /d2/3.7/src/bin/diff/RCS/diff.c,v 1.1 89/03/27 14:53:55 root Exp $";
/*
 * $Log:	diff.c,v $
 * Revision 1.1  89/03/27  14:53:55  root
 * Initial check-in for 3.7
 * 
 * Revision 1.3  85/07/08  16:46:10  bob
 * Fixed bug causing core dump if one of files was "-" (stdin).
 * 
 */
...
#define class Class	/* ieee floating point name collision */
