...
static	char	*Sccsid = "@(#)$Header: /d2/3.7/src/bin/ed/RCS/ed.c,v 1.1 89/03/27 14:53:59 root Exp $";
/*
 * $Log:	ed.c,v $
 * Revision 1.1  89/03/27  14:53:59  root
 * Initial check-in for 3.7
 * 
 * Revision 1.2  85/04/19  17:11:34  bob
 * IFDEFed out cryptographic code.
 * 
 */
