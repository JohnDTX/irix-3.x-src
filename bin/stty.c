...
/*	@(#)stty.c	1.3	*/
static	char	*Sccsid = "@(#)$Header: /d2/3.7/src/bin/RCS/stty.c,v 1.1 89/03/27 14:51:11 root Exp $";
...
struct mds cmodes[] = {
	...
	"sane", (CS8|CREAD), (CSIZE|PARODD|CLOCAL),
	0
};
