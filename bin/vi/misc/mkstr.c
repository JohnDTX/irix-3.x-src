...
static	char	*sccsid = "@(#)mkstr.c	2.3";
/* $Source: /d2/3.7/src/bin/vi/misc/RCS/mkstr.c,v $ */
static	char	*Sccsid = "@(#)$Revision: 1.1 $";
/* $Date: 89/03/27 14:56:26 $ */
 ...
 *
 * Modified by Jeff Schriebman 7-81 to allow for user specified
 * subroutine name not just 'error(' via a -anyname( parameter.
 */
...
char	*progname;
char	*pattern;
char	usagestr[] = "usage: %s [ - ] [ -anyname( ] mesgfile prefix file ...\n";
char	name[100], *np;
