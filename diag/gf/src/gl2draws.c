...
unsigned short drawtests[][256] = {
	...
	7,				/* clear hit */
	0x508,0x34,0,0, 0x16,1,0xdf,	/* drawmode, config bits	*/
	...
	0x408,0x13,0,0,0x3ff,0x3ff,		/* viewport */
	0x108,0x14,0,			/* color */
	...
	0x108,0x14,2,
	0x408,0x10,0,0,0,0,
	0x408,0x11,0x300,0x300,0,0,
	0x408,0x11,0x40,0,0,0x40,
	0x408,0x11,0x340,0x300,0,0x80,
	0x408,0x11,0x80,0,0,0xc0,
    GEOF},
};
