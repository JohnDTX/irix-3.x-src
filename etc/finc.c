...
static	char	*Sccsid = "@(#)$Header: /d2/3.7/src/etc/RCS/finc.c,v 1.1 89/03/27 15:37:42 root Exp $";
/*
 * $Log:	finc.c,v $
 * Revision 1.1  89/03/27  15:37:42  root
 * Initial check-in for 3.7
 * 
 * Revision 1.1  86/04/04  15:22:01  root
 * Initial revision
 * 
