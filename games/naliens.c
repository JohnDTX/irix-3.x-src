...
/*      row maxrow is bottom-of-screen.  The leftmost column is 0; the rightmost
/*      is 79.
*/
        pos(row,col)
...
*/
         ...
         */
        if ((bem.row>=(maxrow-3))&&(bem.row<=22)&&(barr[bem.row-(maxrow-3)][bem.col]!=' ')) {
                pos(bem.row,bem.col);
                puts(" \10\12 ");
                barr[bem.row-(maxrow-3)][bem.col] = ' ';
                bem.row = 0;
                return;
        }
        /*
...
*/
        bomb() {
                ...
                if((bmb[b].row>=(maxrow-3))&&(bmb[b].row<maxrow)&&(barr[bmb[b].row-(maxrow-3)][bmb[b].col]!=' ')) {
                        /*
                         * the bomb has hit a barricade
                         */
                        pos(bmb[b].row-1,bmb[b].col);
                        puts(" \10\12*\10 ");
                        barr[bmb[b].row-(maxrow-3)][bmb[b].col] = ' ';
                        bmb[b].row = 0;
                        bmb_cnt--;
                        return;
                }
