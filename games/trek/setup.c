...
setup(two)
{
	...
	time(&timevec); srand((unsigned)timevec);
	...
	Param.phasfac = 0.8;
	Param.hitfac = 0.5;
	Param.moveprob[KM_OB] = 40;
	Param.movefac[KM_OB] = .09;
	Param.moveprob[KM_OA] = 35;
	Param.movefac[KM_OA] = -0.05;
	Param.moveprob[KM_EB] = 35;
	Param.movefac[KM_EB] = 0.075;
	Param.moveprob[KM_EA] = 20 + 5 * Game.skill;
