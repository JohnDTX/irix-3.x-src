 ...
 */
{
    ...
    if (!ismex()){		/* If not in the window manager, too bad. */
	printf("You must be in the window manager to run this program.\n");
 ...
 */
{
    ...
    mainmen = defpup("Gouraud Shading %t|Reset %f|Exit", init_polygon);
}
