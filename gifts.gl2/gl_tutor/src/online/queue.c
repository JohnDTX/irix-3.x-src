...
int highlighted;
{
...
#ifdef FORTRAN
	    case 1:
		charstr("call qdevic (RIGHTMOUSE)");
		break;
	    case 2:
		charstr("call qdevic (MIDDLEMOUSE)");
		break;
	    case 3:
		charstr("call qdevic (LEFTSHIFTKEY)");
		break;
	    case 4:
	        charstr("call qdevic (RIGHTSHIFTKEY)");
		break;
	    case 5:
...
#ifdef FORTRAN
	    case 8:
		charstr("call tie(RIGHTMOUSE, MOUSEX, MOUSEY)");
		break;
	    case 9:
		charstr("call tie (RIGHTMOUSE, 0, 0)");
		break;
#else
	    case 8:
	...
	switch(i) {
		...
		break;
	    case 13:
		charstr("call qenter(MIDDLEMOUSE, 0)");
		break;
	    case 14:
		charstr("call qenter(MIDDLEMOUSE, 1)");
		break;
#else
	    case 10:
		charstr("dev = qread(&val);");
