...
(* buttons *)
     ...
     BUT142      = 143  (* 142+BUTOFFSET *);
     BUT143      = 144  (* 143+BUTOFFSET *);
     BUT144      = 145  (* 144+BUTOFFSET *);
     BUT145      = 146  (* 145+BUTOFFSET *);
     BUT146      = 147  (* 146+BUTOFFSET *);
     BUT147      = 148  (* 147+BUTOFFSET *);
     BUT148      = 149  (* 148+BUTOFFSET *);
     BUT149      = 150  (* 149+BUTOFFSET *);
     BUT150      = 151  (* 150+BUTOFFSET *);
     BUT151      = 152  (* 151+BUTOFFSET *);
     BUT152      = 153  (* 152+BUTOFFSET *);
     BUT153      = 154  (* 153+BUTOFFSET *);
     BUT154      = 155  (* 154+BUTOFFSET *);
     BUT155      = 156  (* 155+BUTOFFSET *);
     BUT156      = 157  (* 156+BUTOFFSET *);
     BUT157      = 158  (* 157+BUTOFFSET *);
     BUT158      = 159  (* 158+BUTOFFSET *);
     BUT159      = 160  (* 159+BUTOFFSET *);
     BUT160      = 161  (* 160+BUTOFFSET *);
     BUT161      = 162  (* 161+BUTOFFSET *);
     BUT162      = 163  (* 162+BUTOFFSET *);
     BUT163      = 164  (* 163+BUTOFFSET *);
     BUT164      = 165  (* 164+BUTOFFSET *);
     BUT165      = 166  (* 165+BUTOFFSET *);
     BUT166      = 167  (* 166+BUTOFFSET *);
     BUT167      = 168  (* 167+BUTOFFSET *);
     BUT168      = 169  (* 168+BUTOFFSET *);
     MOUSE1      = 101  (* BUT100 *);
     MOUSE2      = 102  (* BUT101 *);
     MOUSE3      = 103  (* BUT102 *);
     ...
     MENUBUTTON  = 101  (* BUT100 *);
     LPENBUT     = 104	(* LIGHT PEN BUTTON *);
     BPAD0     	 = 105	(* BITPAD BUTTON 0 *);
     BPAD1     	 = 106	(* BITPAD BUTTON 1 *);
     BPAD2     	 = 107	(* BITPAD BUTTON 2 *);
     BPAD3     	 = 108	(* BITPAD BUTTON 3 *);
     LPENVALID	 = 109	(* LIGHT PEN VALID *);
     SWBASE      = 111  (* BUT110 *);
     SW0         = 111  (* SWBASE *);
     SW1         = 112  (* SWBASE+1 *);
     SW2         = 113  (* SWBASE+2 *);
...
(* valuators *)
     ...
     LPENX       = 268	(* 12+VALOFFSET *);
     LPENY       = 269	(* 13+VALOFFSET *);
     BPADX       = 270	(* 14+VALOFFSET *);
     BPADY       = 271	(* 15+VALOFFSET *);
     CURSORX     = 272	(* 14+VALOFFSET *);
     CURSORY     = 273	(* 15+VALOFFSET *);
     GHOSTX      = 274	(* 14+VALOFFSET *);
     GHOSTY      = 275	(* 15+VALOFFSET *);

(* timers *)

     TIMER0      = 515	(* 0+TIMOFFSET *);
     TIMER1      = 516	(* 1+TIMOFFSET *);
     TIMER2      = 517	(* 2+TIMOFFSET *);
     TIMER3      = 518	(* 3+TIMOFFSET *);

(* misc devices *)

     KEYBD       = 513	(* 1+KEYOFFSET *);
     VALMARK     = 523	(* valuator mark *);
     GERROR      = 524	(* errors device *);
     REDRAW      = 528	(* used by port manager to signal redraws *);
     WMSEND      = 529	(* data in proc's shmem *);
     WMREPLY     = 530	(* reply from port manager *);
     WMGFCLOSE   = 531	(* gf # is no longer being used *);
     WMTXCLOSE   = 532	(* tx # is no longer being used *);
     MODECHANGE  = 533	(* the display mode has changed *);
     INPUTCHANGE = 534	(* input connected or disconnected *);
     QFULL       = 535	(* queue was filled *);
     PIECECHANGE = 536	(* change in the window pieces *);
     WINCLOSE    = 537  (* window close *);
