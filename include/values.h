/*
 * $Source: /d2/3.7/src/include/RCS/values.h,v $
 * $Revision: 1.1 $
 * $Date: 89/03/27 16:12:14 $
 */
...
#define MAXDOUBLE	((long float) 1.79769313486231570e307)
...
#define _FEXPLEN	8
#define DSIGNIF	(BITSPERBYTE * sizeof(long float) - _DEXPLEN + _HIDDENBIT - 1)
#define FSIGNIF	(BITSPERBYTE * sizeof(float)  - _FEXPLEN + _HIDDENBIT - 1)
#define _LMAX	(BITSPERBYTE * sizeof(long) - 2)
#define DMAXPOWTWO	((long float)(1L << _LMAX) * (1L << (DSIGNIF - _LMAX - 1)))
