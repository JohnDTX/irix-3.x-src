...
# define DECR 79
# define EQ 80
# define _FIRST_FCMPOP EQ
# define NE 81
# define LE 82
# define LT 83
# define GE 84
# define GT 85
# define _LAST_FCMPOP GT
# define ULE 86
# define ULT 87
# define UGE 88
# define UGT 89
...
/* GB - enhancement for Clover. Ignore (effectively) the keyword 'signed'.
   see also pftn.c cgram.y and scan.c
*/
# define SIGNED 1
# define CHAR 2
# define SHORT 3
...
#define shiftop(o) (dope[o]&SHFFLG)	/* GB -SGI bug69 for sucomp() */

/*	table sizes	*/

# define BCSZ 100 /* size of the table to save break and continue labels */

/* changed ** (GB) 7/25/83 was 450 */
/* changed ** (GB) 7/16/86 was 1500 */
/* changed ** (GB) 10/3/86 was 2000 */
# define SYMTSZ 3000 /* size of the symbol table */

# define DIMTABSZ 10000 /* size of the dimension/size table (changed from 800,
			  10/5/83 GB ) */
# define PARAMSZ 300 /* size of the parameter stack (changed from 150,
			   8/19/86 GB) */
# ifndef FORT
/*# define TREESZ 350 /* space for building parse tree */
# define TREESZ 700 /* space for building parse tree  - increased from 350
		      per bug103 (scr1297) (GB 12/6/85) */
# else
# define TREESZ 1000
# endif
# define SWITSZ 500 /* size of switch table */

# define NCHNAM 32  /* number of characters in a name */
# define NAME_FMT "%.32s"
