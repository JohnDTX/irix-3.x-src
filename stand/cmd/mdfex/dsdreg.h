/*
** dsdreg.h	- Copyright (C) Silicon Graphics - Mountain View, CA 94043
**		- Author: chase
**		- Date: April 1985
...
**	$Author: root $
**	$State: Exp $
**	$Source: /d2/3.7/src/stand/cmd/mdfex/RCS/dsdreg.h,v $
**	$Revision: 1.1 $
**	$Date: 89/03/27 17:12:47 $
*/

#ifdef pmII
#define	IOBASE	0xf70000		/* Base of MBUS I/O */
#endif
#ifdef juniper
#define	IOBASE	0x50000000		/* Base of MBUS I/O */
#endif

#define	CLEAR()	(*((char *)(IOBASE+ioport+1)) = zero)
#define	START()	(*((char *)(IOBASE+ioport+1)) = 1)
#define	RESET()	(*((char *)(IOBASE+ioport+1)) = 2)
...
/* #define INTEL(x) (UCHAR *)((((ULONG)x)<<16)|((((ULONG)x)>>4)&0xF000)) */
#ifdef pmII
#define	INTEL(x) (UCHAR *)SWAPW((x))
#endif
#ifdef juniper
#include "mbenv.h"
#define	INTEL(x) (UCHAR *)SWAPW(mbvtop(x))
#endif
/* #define UNINTEL(x) (UCHAR *)((((ULONG)x)>>16)|((((ULONG)x)&0xF000)<<4)) */
#define UNINTEL(x) (UCHAR *)SWAPW((x))

struct	wub {
	UCHAR	w_xx;		/*1  *//* UNUSED */
	UCHAR	w_ext;		/*0  *//* extension */
	UCHAR	*w_ccb;		/*2-5*//* Ptr to ccb */
};
typedef	struct wub wub_t;

/* #define W_EXT  1		/* Normal 215 */
/* #define W_EXT  5		/* Extended For extended Status */
...
struct	cib {
	...
	UCHAR	*i_csa;		/*4-7*//* UNUSED */ /* must be all zeros */
	UCHAR	*i_iopb;	/*8-b*//* IOPB Pointer */
