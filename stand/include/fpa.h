/*
* $Source: /d2/3.7/src/stand/include/RCS/fpa.h,v $
* $Revision: 1.1 $
* $Date: 89/03/27 17:13:42 $
*/
/*
**
...
*/
#define fpaopcodeL(opc,reg)	    *((u_long *)(SEG_FPA|((opc)<<8)|((reg)<<4)))
#define fpaopcodeB(opc,dst,src) *((u_char *)(SEG_FPA|((opc)<<8)|((dst)<<4)|(src)))
