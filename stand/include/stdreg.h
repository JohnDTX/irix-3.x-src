/*
* $Source: /d2/3.7/src/stand/include/RCS/stdreg.h,v $
* $Revision: 1.1 $
* $Date: 89/03/27 17:13:52 $
*/
/*
...
struct	softc_disk {
	...
	struct	buf sc_rawbuf;		/* raw buffer header */
};
...
struct	softc {
	...
	struct	softc_disk sc_disk[MAX_WINNYS+MAX_FLOPPYS];
} stdsoftc;
