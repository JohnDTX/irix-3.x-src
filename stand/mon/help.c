/*
* $Source: /d2/3.7/src/stand/mon/RCS/help.c,v $
* $Revision: 1.1 $
* $Date: 89/03/27 17:15:33 $
*/
...
printf( "      tcp	- TCP network.\n" );
printf( "      xns	- XNS network.\n" );
printf( "      rom	- EPROM board.\n" );
printf( "  DEVSPEC is the one of the following:\n" );
printf( "      host name		- name of a host. (MEDIA must be tcp or xns.)\n" );
