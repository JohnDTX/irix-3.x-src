...
** streg.h
**
** $Source: /d2/3.7/src/stand/pm2mon/dev/RCS/streg.h,v $
** $Date: 89/03/27 17:17:15 $
** $Revision: 1.1 $
**
...
*/
#define ST_R1	0
#define ST_R0	1	/* For the SUN CPU they must be byte swapped */
#define ST_R3	2
#define ST_R2	3
#define ST_R5	4
#define ST_R4	5
...
#define	DCLEAR(rp)	(rp[ST_R0] = (ST_CLEAR|ST_NOINT))
#define	DZERO(rp)	(rp[ST_R0] = (ST_16BITS|ST_NOINT))
#define	DSTART(rp)	(rp[ST_R0] = (ST_START|ST_NOINT))
#define	DRESET(rp)	(rp[ST_R0] = (ST_RESET|ST_NOINT))
#define	DABORT(rp)	(rp[ST_R0] = (ST_ABORT|ST_NOINT))
#define DSTATUS(rp)	(rp[ST_R0])
#define DRDINT(rp)	(rp[ST_R1])
