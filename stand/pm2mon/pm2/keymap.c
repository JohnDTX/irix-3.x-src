...
/* File: keymap.c:  This file contains the initialization of the keyb map
 * array for the SGI keyboard.  The normal ascii part of the keyboard behaves
...
struct MapTable {
    ...
    char	shiftAscii;
    char	cntrlAscii;
    char	cntrlShiftAscii;
};

/*
 * this struct may be viewed as an array,
 * indexed by state bits:
 * SHIFT (01) and CNTRL (02)
 */

struct MapTable KeyMap[] = {
	{0xff, 0xff, 0xff, 0xff},	/* BUTTON0  - BREAKKEY */
