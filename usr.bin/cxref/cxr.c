...
static	char	*Sccsid = "@(#)$Header: /d2/3.7/src/usr.bin/cxref/RCS/cxr.c,v 1.1 89/03/27 17:43:55 root Exp $";
/*
 * $Log:	cxr.c,v $
 * Revision 1.1  89/03/27  17:43:55  root
 * Initial check-in for 3.7
 * 
 * Revision 1.3  85/11/12  10:05:32  jym
 * Sort lives in /usr/bin
 * 
 * Revision 1.2  85/03/11  21:16:34  bob
 * Fixed to search for "sort" rather than assuming it is in /bin (it's
 * currently in /usr/bin).
 * 
 */
