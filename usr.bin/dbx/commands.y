...
static char rcsid[] = "$Header: /d2/3.7/src/usr.bin/dbx/RCS/commands.y,v 1.1 89/03/27 17:44:21 root Exp $";
...
%term
    ...
    STOP STOPI TRACE TRACEI UNALIAS UNSET UP USE DISASS
    WHATIS WHEN WHERE WHEREIS WHICH DISPLAY
...
|
	DISASS line_number ',' line_number
{
	disass($2, $4);
}
;
...
keyword:
    ...
    WHATIS | WHEN | WHERE | WHEREIS | WHICH | DISASS | DISPLAY
;
