...
static char rcsid[] = "$Header: /d2/3.7/src/usr.bin/dbx/RCS/library.c,v 1.1 89/03/27 17:44:33 root Exp $";
...
#endif
#ifdef sgi /* or in general for 4.2 - System V C library interface */
