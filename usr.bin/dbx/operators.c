...
static char rcsid[] = "$Header: /d2/3.7/src/usr.bin/dbx/RCS/operators.c,v 1.1 89/03/27 17:44:45 root Exp $";
...
typedef enum {
	...
	O_PBUFON,	/* Pass all standard out messages to edge */
	O_PBUFOFF,	/* Turn off Pass all standard out messages to edge */
...
/* O_DISPLAY */		1,	null,		"display",
/* O_SPRINT */		1,	null,		"sprint",
...
/* O_PBUFON */		0,	null,		"pbufon",
/* O_PBUFOFF */		0,	null,		"pbufoff",
