/*
 * $Source: /d2/3.7/src/usr.bin/edge/common/RCS/window.h,v $
 * $Revision: 1.1 $
 * $Date: 89/03/27 17:46:11 $
 */
#ifndef WINDOWDEF
#define WINDOWDEF
/**************************************************************************
...
#define	XLEN(n)		((n) * charwidth)	/* length in pix of n chars */
#define	YLEN(n)		((n) * charheight)	/* height in pix of n chars */
...
struct	txport txport[5];
extern	int	dpagecolor, dtextcolor;
