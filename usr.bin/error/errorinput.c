...
static	char	*Sccsid = "@(#)$Header: /d2/3.7/src/usr.bin/error/RCS/errorinput.c,v 1.1 89/03/27 17:49:39 root Exp $";
/*
 * $Log:	errorinput.c,v $
 * Revision 1.1  89/03/27  17:49:39  root
 * Initial check-in for 3.7
 * 
 * Revision 1.2  85/01/30  01:31:26  bob
 * Fixed to not core dump (ref thru zero).
 * 
 */
#include <stdio.h>
#include <ctype.h>
