...
; Adjust stack to new positions, preserving D0, D2, A1
        ...
        MOVE.L  D0,SP
;        TST.B   -4096(SP)       ; Generate Unix trap for more stack if needed
...
; Initialize heap pointer
        MOVEM.L D1-D7/A0-A6,-(SP) ; OK regardless what _sbrk clobbers
        MOVE.L  #100,-(SP)      ; Requesting 100 bytes and address of start
        JSR     _sbrk           ; Get start of heap and allocate 100 bytes
        ADDQ.W  #4,SP           ; Discard parameter
        MOVEM.L (SP)+,D1-D7/A0-A6
; D0 is address of start of heap
        MOVE.L  D0,D1           ; Need a copy to destroy
        ANDI.L  #1,D1           ; Is it odd?
        BEQ.S   EVEN
        ADDQ.L  #1,D0           ; Make it even
EVEN    MOVE.L  D0,24(SP)       ; Set FREEMEM
        ADD.L   #98,D0          ; Calculate BREAKADDR, conservative if odd
        MOVE.L  D0,1864(SP)     ; Set BREAKADDR 
