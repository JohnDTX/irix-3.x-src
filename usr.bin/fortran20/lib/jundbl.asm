; File: jundbl.text - Combination of DPK and DCMP for Juniper
; Date: 27-Jun-85

        IDENT   JUNDBL

        GLOBAL  %D_MAX,%D_MIN,%D_DIM,%D_SIGN
...
%D_DIM
        ...
        move.l  4(sp),$9110.w   ; J_DSUB   y,F1
        move.b  d0,$B511.w      ; J_DTST   F1
        tst.b   $8700.w         ; J_CR
        bge.s   dimrts
        move.l  #0,$8410.w      ; J_MOVELO 0,F1
        move.l  #0,$8310.w      ; J_MOVEHI 0,F1
dimrts  rtd     #16
...
%D_MAX
        ...
        move.l  12(sp),$8310.w  ; J_MOVEHI x,F1
        move.l  8(sp),$8400.w   ; J_MOVELO y,F0
        move.l  4(sp),$B310.w   ; J_DCMP   y,F1
        tst.b   $8700.w         ; J_CR
        bge.s   maxrts
        move.l  8(sp),$8410.w   ; J_MOVELO y,F1
        move.l  4(sp),$8310.w   ; J_MOVEHI y,F1
maxrts  rtd     #16
...
;
; function %D_SIGN(x,y: double): double;
;
; Transfer the sign of the second arg to the first.
;

%D_SIGN
        roxl    12(sp)          ; Kill sign in arg1
        roxl    4(sp)           ; Get sign of arg2
        roxr    12(sp)          ; Copy sign
        move.l  16(sp),$8410.w  ; J_MOVELO xxx,F1
        move.l  12(sp),$8310.w  ; J_MOVEHI xxx,F1
        rtd     #16
        end
; File: dpk.text
; Date: 09-Jan-85
