...
static char *RCSID="$Header: /d2/3.7/src/usr.bin/print/trscript/src/RCS/enscript.c,v 1.1 89/03/27 18:20:37 root Exp $";
#endif
/* enscript.c
 *
 ...
 * RCSLOG:
 * $Log:	enscript.c,v $
 * Revision 1.1  89/03/27  18:20:37  root
 * Initial check-in for 3.7
 * 
 * Revision 1.1  86/11/17  20:21:02  root
 * Initial revision
 * 
