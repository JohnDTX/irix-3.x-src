...
static char *RCSID = "$Header: /d2/3.7/src/usr.bin/print/trscript/src/RCS/ps4014.c,v 1.1 89/03/27 18:20:42 root Exp $";
#endif
/* ps4014.c
 *
 ...
 * RCSLOG:
 * $Log:	ps4014.c,v $
 * Revision 1.1  89/03/27  18:20:42  root
 * Initial check-in for 3.7
 * 
 * Revision 1.1  86/11/17  20:21:43  root
 * Initial revision
 * 
