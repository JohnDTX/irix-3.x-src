...
static char *RCSID="$Header: /d2/3.7/src/usr.bin/print/trscript/src/RCS/psdit.c,v 1.1 89/03/27 18:20:51 root Exp $";
#endif
/* psdit.c
 *
 ...
 * RCSLOG:
 * $Log:	psdit.c,v $
 * Revision 1.1  89/03/27  18:20:51  root
 * Initial check-in for 3.7
 * 
 * Revision 1.1  86/11/17  20:23:41  root
 * Initial revision
 * 
