...
/* $Log:	maketime.c,v $
 * Revision 1.1  89/03/27  18:21:39  root
 * Initial check-in for 3.7
 * 
 * Revision 1.1  85/10/30  16:08:56  brendan
 * Initial revision
 * 
 * Revision 1.2  84/05/07  15:33:37  bob
 * Its ifdefs are sensitive to SYS5 as well as SYSTEM5.
 * 
 * Revision 1.1  84/05/07  15:29:11  bob
 * Initial revision
 * 
 * Revision 1.2  83/09/09  13:41:49  ellis
 * ported to SGI
 * 
...
#ifdef	SYSTEM5
	tzset();
	return(_lclzon >= 0 ? _lclzon : (_lclzon = timezone/(60*60)));
#else /* V7, 4.2 */
	struct timeb tb;
