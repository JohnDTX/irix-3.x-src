 ...
 */
 static char rcsid[]=
 "$Header: /d2/3.7/src/usr.bin/rcs/src/rcs/RCS/rcsgen.c,v 1.1 89/03/27 18:21:49 root Exp $ Purdue CS";
/*********************************************************************************
 *********************************************************************************
 *
 ...
 * 
 * Revision 1.1  85/10/30  16:09:40  brendan
 * Initial revision
 * 
 * Revision 3.4  83/09/09  13:43:41  ellis
 * ported to SGI
 * 
