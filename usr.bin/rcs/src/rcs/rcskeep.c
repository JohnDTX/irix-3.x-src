 ...
 */
 static char rcsid[]=
 "$Header: /d2/3.7/src/usr.bin/rcs/src/rcs/RCS/rcskeep.c,v 1.1 89/03/27 18:21:49 root Exp $ Purdue CS";
/*****************************************************************************
...
/* $Log:	rcskeep.c,v $
 * Revision 1.1  89/03/27  18:21:49  root
 * Initial check-in for 3.7
 * 
 * Revision 1.1  85/10/30  16:09:43  brendan
 * Initial revision
 * 
 * Revision 3.3  83/09/09  13:43:55  ellis
 * ported to SGI
 * 
