 ...
 */
 static char rcsid[]=
 "$Header: /d2/3.7/src/usr.bin/rcs/src/rcs/RCS/rcsrev.c,v 1.1 89/03/27 18:21:52 root Exp $ Purdue CS";
/*********************************************************************************
 *********************************************************************************
 *
...
/* $Log:	rcsrev.c,v $
 * Revision 1.1  89/03/27  18:21:52  root
 * Initial check-in for 3.7
 * 
 * Revision 1.1  85/10/30  16:09:56  brendan
 * Initial revision
 * 
 * Revision 3.5  83/09/09  13:44:35  ellis
 * ported to SGI
 * 
