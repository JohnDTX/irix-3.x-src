 ...
 */
 static char rcsid[]=
 "$Header: /d2/3.7/src/usr.bin/rcs/src/rcs/RCS/snoop.c,v 1.1 89/03/27 18:21:58 root Exp $ Purdue CS";
/*******************************************************************
...
/* $Log:	snoop.c,v $
 * Revision 1.1  89/03/27  18:21:58  root
 * Initial check-in for 3.7
 * 
 * Revision 1.1  85/10/30  16:10:34  brendan
 * Initial revision
 * 
 * Revision 3.3  83/09/09  13:46:25  ellis
 * ported to SGI
 * 
