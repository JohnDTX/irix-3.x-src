...
#define PRO	SINFO+4
#define V	SINFO+5
#define RLCNT	SINFO+6
#define GDCNT	SINFO+7
#define SERR	SINFO+8
#endif m68000
...
#ifdef m68000
#define NCTRA	1  /* number of type 1 disk controllers  */
#define NCTRB	1  /* number of type 2 disk controllers  */
#define NCTRC	1  /* number of floppy disk controllers  */
#define NCTRD	1  /* number of tape controllers  */
#define NDRA	1  /* number of data units for disk 1 controller  */
#define NDRB	1  /* number of data units for disk 2 controller  */
#define NDRC	1  /* number of data units for floppy disk controller  */
#define NDRD	1  /* number of data units for tape controller  */
/*	this is for gd device	*/
/*	NDEVS defines number of total data units 
*/
#define NDEVS NCTRA *NDRA +NCTRB * NDRB + NCTRC * NDRC + NCTRD * NDRD
/*	iotbsz, devnm tables define the number of drives,
	controller name  of devices
	hpstat, hmstat, hsstat, rfstat, rkstat, rpstat, rlstat,
	gtstst, htstat, tmstat, tsstat,
