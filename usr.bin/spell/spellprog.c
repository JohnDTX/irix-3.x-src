...
/*
 *	in an attempt to defray future maintenance misunderstandings, 
 ...
 *	because of this, there is little error checking (this is historical,
 ...
 *		1. a stop list: this specifies words that 
 *		   by the rules embodied in
 *		   spellprog would be recognized as correct, 
 *		   BUT are really errors.
...
#else
		/*
		 * Limit words to the maximum word length supported.  Extra
		 * characters are lost.
		 */
		wordLength = 0;
		ep = word; 
