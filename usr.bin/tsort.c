...
static	char	*Sccsid = "@(#)$Header: /d2/3.7/src/usr.bin/RCS/tsort.c,v 1.1 89/03/27 17:40:50 root Exp $";
/*
 * $Log:	tsort.c,v $
 * Revision 1.1  89/03/27  17:40:50  root
 * Initial check-in for 3.7
 * 
 * Revision 1.1  87/06/03  17:40:48  vjs
 * Initial revision
 * 
 * Revision 1.3  84/11/15  14:32:37  bob
 * Added "exit(0)" at end of main() for correct return code.
 * 
 * Revision 1.2  84/11/15  14:26:12  bob
 * Ported 4.2bsd version to deal with new object format.
 * 
 */
/*	topological sort
