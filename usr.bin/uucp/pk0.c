...
/*
 * The supplied chksum() is braindamaged. It has been replaced with the
 * bsd4.2 version which also works with V7, System III, etc.
 */
#ifdef BRAINDAMAGE
...
/* This chksum() is from bsd4.2 and works! */
