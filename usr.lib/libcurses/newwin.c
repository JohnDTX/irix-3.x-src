 ...
 * 1/26/81 (Berkeley) %W
 */
static	char	*Sccsid = "@(#)$Header: /d2/3.7/src/usr.lib/libcurses/RCS/newwin.c,v 1.1 89/03/27 18:35:00 root Exp $";
/*
 * $Log:	newwin.c,v $
 * Revision 1.1  89/03/27  18:35:00  root
 * Initial check-in for 3.7
 * 
 * Revision 1.2  85/03/19  18:47:45  bob
 * Fixed a bug whereby the subwindow test failed if beg (y,x) != (0,0)
 * (SCR 477).
 * 
 */
